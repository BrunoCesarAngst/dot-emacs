...
(defun bca/display-startup-time ()
...
(add-hook 'org-mode-hook (lambda () (add-hook 'after-save-hook #'bca/org-babel-tangle-config)))
...
;;     (define-key winum-keymap (kbd "C-u-0") #'treemacs-select-window))
;;   :config
;;   (progn
...
;; Aqui, mudamos o atraso para que a chave consecutiva fosse pouco maior do que o
;; padrão. Ajuste isto para o que você se sentir confortável.
...
(use-package smartparens
	...
	:custom-face
	(sp-show-pair-match-face ((t (:foreground "red")))))
...
(defun bca/ansi-colorize-buffer ()
...
(use-package ansi-color
  :ensure t
:config
(add-hook 'compilation-filter-hook 'bca/ansi-colorize-buffer))
...
(use-package org
  ...
  :hook (org-mode . bca/org-mode-setup)
  :config
  (setq org-ellipsis " ▾")
...
(defun bca/org-mode-visual-fill ()
  (setq visual-fill-column-width 100
        visual-fill-column-center-text t)
  (visual-fill-column-mode 1))

(use-package visual-fill-column
  :hook (org-mode . bca/org-mode-visual-fill))

;; Org-Roam basic configuration
;; O "(getenv "HOME")" substitui o uso do "~/"
(setq org-directory (concat (getenv "HOME") "/www/emacs-teste"))

;; ((nil . ((org-roam-directory . "/Users/bruno/.emacs.d/org-roam-dir")
;;        (org-roam-db-location . "/Users/bruno/.emacs.d/org-roam-dir/org-roam.db"))))
